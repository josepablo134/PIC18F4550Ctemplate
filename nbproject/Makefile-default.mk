...
${OBJECTDIR}/project/source/Board/IIC/IIC_internal.p1: project/source/Board/IIC/IIC_internal.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}/project/source/Board/IIC" 
	@${RM} ${OBJECTDIR}/project/source/Board/IIC/IIC_internal.p1.d 
	@${RM} ${OBJECTDIR}/project/source/Board/IIC/IIC_internal.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=pickit3   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=0 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/project/source/Board/IIC/IIC_internal.p1 project/source/Board/IIC/IIC_internal.c 
	@-${MV} ${OBJECTDIR}/project/source/Board/IIC/IIC_internal.d ${OBJECTDIR}/project/source/Board/IIC/IIC_internal.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/project/source/Board/IIC/IIC_internal.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
