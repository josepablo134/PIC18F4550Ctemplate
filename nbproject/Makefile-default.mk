...
SOURCEFILES_QUOTED_IF_SPACED=project/source/bldrCtl/bldrCtl.c project/source/flashCtl/flash.c project/source/project_macros.c project/source/board_config.c main.c project/source/UART/UART.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/project/source/bldrCtl/bldrCtl.p1 ${OBJECTDIR}/project/source/flashCtl/flash.p1 ${OBJECTDIR}/project/source/project_macros.p1 ${OBJECTDIR}/project/source/board_config.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/project/source/UART/UART.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/project/source/bldrCtl/bldrCtl.p1.d ${OBJECTDIR}/project/source/flashCtl/flash.p1.d ${OBJECTDIR}/project/source/project_macros.p1.d ${OBJECTDIR}/project/source/board_config.p1.d ${OBJECTDIR}/main.p1.d ${OBJECTDIR}/project/source/UART/UART.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/project/source/bldrCtl/bldrCtl.p1 ${OBJECTDIR}/project/source/flashCtl/flash.p1 ${OBJECTDIR}/project/source/project_macros.p1 ${OBJECTDIR}/project/source/board_config.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/project/source/UART/UART.p1

# Source Files
SOURCEFILES=project/source/bldrCtl/bldrCtl.c project/source/flashCtl/flash.c project/source/project_macros.c project/source/board_config.c main.c project/source/UART/UART.c
...
${OBJECTDIR}/project/source/flashCtl/flash.p1: project/source/flashCtl/flash.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/project/source/flashCtl" 
	@${RM} ${OBJECTDIR}/project/source/flashCtl/flash.p1.d 
	@${RM} ${OBJECTDIR}/project/source/flashCtl/flash.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=0 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/project/source/flashCtl/flash.p1 project/source/flashCtl/flash.c 
	@-${MV} ${OBJECTDIR}/project/source/flashCtl/flash.d ${OBJECTDIR}/project/source/flashCtl/flash.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/project/source/flashCtl/flash.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
${OBJECTDIR}/project/source/UART/UART.p1: project/source/UART/UART.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/project/source/UART" 
	@${RM} ${OBJECTDIR}/project/source/UART/UART.p1.d 
	@${RM} ${OBJECTDIR}/project/source/UART/UART.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=0 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/project/source/UART/UART.p1 project/source/UART/UART.c 
	@-${MV} ${OBJECTDIR}/project/source/UART/UART.d ${OBJECTDIR}/project/source/UART/UART.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/project/source/UART/UART.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
